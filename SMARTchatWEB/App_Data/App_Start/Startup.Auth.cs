...
namespace SMARTchatWEB
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication("1843691209200654", "ec929b6e3cccf3a29d233c2dcb71712f");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions
            {
                ClientId = "69927262221-q0jov03hqtu7a8o9ij7mfe10ni0ivlso.apps.googleusercontent.com",
                ClientSecret = "GQO6hOCfmMUmJdwEF3P5MQIp"
            });
        }
    }
}